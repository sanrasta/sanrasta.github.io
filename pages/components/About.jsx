    ...
    <div>
               <div className='grid grid-cols-1 sm:md:md:grid-cols-3 group bg-white shadow-lg shadow-neutral-100 border'>
                ...
                <span className="p-5 rounded-full bg-[#bef264] text-white shadow-lg shadow-[#bef264]-200"><svg
                    ...
                    <p className="text-xl font-medium text-slate-700 mt-3">Team of Solar Experts</p>
                <p className="mt-2 text-sm text-slate-500">Years of experience maximising customer savings and satisfaction</p>
            </div>
            <div className="p-10 flex flex-col items-center text-center group bg-white md:lg:xl:border-b hover:bg-slate-50">
                ...
                <p className="text-xl font-medium text-slate-700 mt-3">Custom Coverages</p>
                <p className="mt-2 text-sm text-slate-500"> We can access any insurance product so you get the right one for your needs.</p>
            </div>
