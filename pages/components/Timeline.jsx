...
const Timeline = ({}) => {
    return(
      ...
      <p className='text-2xl font-bold p-8 gap-8 py-24'> It is a simple five step process that only requires your utility bill to get started.
    </p>
  ...
  <div className="relative wrap overflow-hidden p-10 h-full">
    ...
    <div className="mb-8 flex justify-between items-center w-full right-timeline">
      ...
      <div className="order-1 bg-gray-400 rounded-lg shadow-xl w-5/12 px-6 py-6">
        <h3 className="mb-3 font-bold text-gray-800 text-xl">Collect<br></br>Your Energy Bill</h3>
   ...
   {/*  right timeline*/} 
    ...
    <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
      ...
      <div className="order-1 bg-[#4B5335] rounded-lg shadow-xl w-5/12 px-6 py-6">
