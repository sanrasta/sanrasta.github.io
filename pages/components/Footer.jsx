      ...
      <footer className="bg-gray-100 ">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 position-relative">
          ...
          <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
            This is a solicitation for business.<br></br>&quot;If you have a claim for insured property loss or damage and you are satisfied with the payment by your insurance company, you may disregard this advertisement.&quot;
          </p>
